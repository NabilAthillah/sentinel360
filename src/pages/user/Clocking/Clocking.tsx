...
const ClockingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#181D26] text-[#F4F7FF] p-4 flex flex-col gap-7 pt-10">
            <div className="flex items-center gap-3 ">
                <ChevronLeft
                    ...
                    onClick={() => navigate(-1)}
                />
                <h1 className="text-xl text-[#F4F7FF] font-normal">Clocking</h1>
            </div>
            ...
            {activeTab === 'Sites' && (
                <div className="flex flex-col items-center justify-center flex-1 mt-20">
                    <div className="w-40 h-40 bg-gray-700"></div>
                    <p className="mt-4 text-[#F4F7FF]">No data available</p>
                </div>
            )}
                    ...
                    {historyData.map((item) => (
                        ...
                        >
                            ...
                            <div className="text-sm text-[#98A1B3] gap-2 flex flex-col">
                                ...
                                <div>
                                    <p className="mb-1 text-xs">Clocking point</p>
                                    <p className="text-[#F4F7FF]">{item.clockingPoint}</p>
                                </div>
                                <div>
                                    <p className="mb-1 text-xs">Clocking location</p>
                                    <p className="text-[#F4F7FF]">{item.clockingLocation}</p>
                                </div>
                                <div>
                                    <p className="mb-1 text-xs">Remark</p>
