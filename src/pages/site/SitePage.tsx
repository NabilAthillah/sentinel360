                                    ...
                                    {sites.length > 0 && sites.map((site, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="text-[#F4F7FF] pt-6 pb-3 ">
                                                {site.image != '' && (
                                                    <img src={`${baseURL.toString() != '' ? baseURL.toString() : 'http://localhost:8000/'}storage/${site.image}`} alt="Image" className='h-14 w-fit' />
                                                )}
                                            </td>
                    ...
                    <form onSubmit={handleUpdate} className="fixed w-screen h-screen flex justify-end items-start top-0 left-0 z-50 bg-[rgba(0,0,0,0.5)]">
                        <div className="flex flex-col gap-6 p-6 bg-[#252C38] max-w-[568px] w-full max-h-screen overflow-auto h-full">
                            ...
                            <div className="flex gap-4 flex-wrap">
                                ...
                                <p onClick={() => setEditData(false)} className="cursor-pointer font-medium text-base leading-[21px] text-[#868686] bg-[#252C38] px-12 py-3 border-[1px] border-[#868686] rounded-full transition-all hover:bg-[#868686] hover:text-[#252C38]">Cancel</p>
                            </div>
                        </div>
                    </form>
                )
