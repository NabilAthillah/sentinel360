                            ...
                            <table className="min-w-[700px] w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="font-semibold text-[#98A1B3] text-start">Employee name</th>
                                        <th className="font-semibold text-[#98A1B3] text-start">Role</th>
                                        <th className="font-semibold text-[#98A1B3] text-start">Approved by</th>
                                        <th className="font-semibold text-[#98A1B3] text-start">Status</th>
                                        <th className="font-semibold text-[#98A1B3] text-start">Date of completion</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-[#F4F7FF] pt-6 pb-3">Dinesh</td>
