...
const DashboardPage = () => {
  ...
  return (
    <SecondLayout>
      ...
      <div className="flex flex-col gap-10 px-6 pb-20 w-full xl:pr-[156px] h-full">
        <h2 className="text-2xl leading-9 text-white font-noto">
          Hello {user?.name}
        </h2>

        <div className="md:h-[630px] flex flex-col flex-1 gap-6">
          {/* Row 1 */}
          <div className="flex gap-6 flex-1 w-full flex-col md:flex-row">
            {hasPermission("list_employees") && (
              <div
                className="flex flex-col items-center justify-center rounded-2xl bg-[#2A1F2E] p-6 shadow-md cursor-pointer hover:scale-105 transition-transform w-full min-w-[204px] md:max-w-[204px]"
                onClick={() => navigate("/dashboard/employees")}
              >
                <span className="text-pink-400 text-4xl mb-3">
                  <svg
                    width="56"
                    height="57"
                    viewBox="0 0 56 57"
                  ...
                  >
                    <g clip-path="url(#clip0_29_3314)">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M38.8966 31.1367C42.0933 33.3067 44.3333 36.2467 44.3333 40.1667V47.1667H53.6666V40.1667C53.6666 35.0801 45.3366 32.0701 38.8966 31.1367Z"
                        fill="#C76390"
                      />
                      <path
                        d="M21 28.4997C26.1547 28.4997 30.3334 24.321 30.3334 19.1663C30.3334 14.0117 26.1547 9.83301 21 9.83301C15.8454 9.83301 11.6667 14.0117 11.6667 19.1663C11.6667 24.321 15.8454 28.4997 21 28.4997Z"
                        fill="#C76390"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M34.9999 28.4997C40.1566 28.4997 44.3333 24.323 44.3333 19.1663C44.3333 14.0097 40.1566 9.83301 34.9999 9.83301C33.9033 9.83301 32.8766 10.0663 31.8966 10.393C33.8333 12.7963 34.9999 15.853 34.9999 19.1663C34.9999 22.4797 33.8333 25.5363 31.8966 27.9397C32.8766 28.2663 33.9033 28.4997 34.9999 28.4997Z"
                        fill="#C76390"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M21 30.833C14.77 30.833 2.33331 33.9597 2.33331 40.1663V47.1663H39.6666V40.1663C39.6666 33.9597 27.23 30.833 21 30.833Z"
                        fill="#C76390"
                      />
                    </g>
                    <defs>
            ...
            {hasPermission("list_employee_attendances") && (
              <div
                className="flex flex-col items-center justify-center rounded-2xl bg-[#1E2535] p-6 shadow-md cursor-pointer hover:scale-105 transition-transform md:w-1/2"
                      ...
                      >
                        <g clip-path="url(#clip0_29_3596)">
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M23.4 30.901C19.9534 30.901 17.1595 28.0355 17.1595 24.5006C17.1595 20.9656 19.9534 18.1001 23.4 18.1001C26.8464 18.1001 29.6405 20.9656 29.6405 24.5006C29.6405 26.198 28.9828 27.8259 27.8128 29.0263C26.6425 30.2267 25.0552 30.901 23.4 30.901Z"
                            stroke="#E2D374"
                            stroke-width="6.00044"
                          ...
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M39.9903 37.5033V33.2086C39.9903 32.1452 40.4021 31.1252 41.1353 30.3732L44.0965 27.3362C45.6233 25.7703 45.6233 23.2312 44.0965 21.6654L41.1353 18.6283C40.4021 17.8763 39.9903 16.8564 39.9903 15.7929V11.495C39.9903 9.28038 38.2397 7.48508 36.0805 7.48508H31.8902C30.8533 7.48508 29.8587 7.06259 29.1255 6.3106L26.1643 3.27358C24.6375 1.70764 22.1621 1.70764 20.6353 3.27358L17.6743 6.3106C16.9411 7.06259 15.9467 7.48508 14.9098 7.48508H10.7193C9.68185 7.48508 8.68696 7.908 7.95366 8.66069C7.22036 9.41339 6.80884 10.4341 6.80967 11.4982V15.7929C6.80964 16.8564 6.39774 17.8763 5.66453 18.6283L2.70345 21.6654C1.17665 23.2312 1.17665 25.7703 2.70345 27.3362L5.66453 30.3732C6.39774 31.1252 6.80964 32.1452 6.80967 33.2086V37.5033C6.80967 39.7179 8.56007 41.5132 10.7193 41.5132H14.9098C15.9467 41.5132 16.9411 41.9356 17.6743 42.6877L20.6353 45.7247C22.1621 47.2906 24.6375 47.2906 26.1643 45.7247L29.1255 42.6877C29.8587 41.9356 30.8533 41.5132 31.8902 41.5132H36.0773C37.1149 41.5142 38.1101 41.0921 38.844 40.3397C39.5778 39.5876 39.9903 38.5674 39.9903 37.5033Z"
                            stroke="#E2D374"
                            stroke-width="6.00044"
                            stroke-linecap="round"
                            stroke-linejoin="round"
          ...
          <div className="flex gap-6 flex-1 w-full flex-col md:flex-row">
            {hasPermission("list_sites") && (
              <div
                className="flex flex-col items-center justify-center rounded-2xl bg-[#2D2A41] p-6 shadow-md cursor-pointer hover:scale-105 transition-transform w-full min-w-[204px] md:max-w-[204px]"
            ...
            <div className="md:w-1/2 flex gap-6 flex-col md:flex-row">
                ...
                >
                  <span className="text-pink-400 text-4xl mb-3">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M45 15.4999V17.3749H46.875V15.4999H45ZM12.6777 17.3749H45V13.6249H12.6777V17.3749ZM46.875 15.4999V11.265H43.125V15.4999H46.875ZM39.0278 4.45906L12.0338 8.31534L12.5641 12.0276L39.558 8.17136L39.0278 4.45906ZM12.0338 8.31534C9.79095 8.63574 8.125 10.5566 8.125 12.8222H11.875C11.875 12.4228 12.1687 12.0841 12.5641 12.0276L12.0338 8.31534ZM46.875 11.265C46.875 7.08119 43.1695 3.86739 39.0278 4.45906L39.558 8.17136C41.4408 7.90244 43.125 9.36323 43.125 11.265H46.875ZM12.6777 13.6249C12.2344 13.6249 11.875 13.2655 11.875 12.8222H8.125C8.125 15.3366 10.1633 17.3749 12.6777 17.3749V13.6249Z"
                          fill="#C9894D"
                        />
                        <path
                          d="M20 30.5H40"
                        ...
                        />
                        <path
                          d="M10 15.5V48C10 52.1423 13.3579 55.5 17.5 55.5H42.5C46.6423 55.5 50 52.1423 50 48V35.5M10 15.5V13M10 15.5H42.5C46.6423 15.5 50 18.8579 50 23V25.5"
                          stroke="#C9894D"
                          stroke-width="3.75"
                          stroke-linecap="round"
                        />
