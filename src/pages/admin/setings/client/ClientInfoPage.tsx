...
const ClientInfoPage = () => {
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        try {
            ...
            const response = await clientInfoService.updateData(
                token,
                payload,
                client.id
            );
                                ...
                                {loading ? (
                                    <div className="animate-pulse w-full">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="h-3 w-44 bg_white/10 rounded" />
                                            <div className="h-3 w-56 bg-white/10 rounded" />
                                    ...
                                    <>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <p className="text-base leading-[20px] text-[#F4F7FF]">
                                                {client.reg_no}
                                            </p>
                                        </div>
                                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex gap-4 flex-wrap">
                                {hasPermission("edit_client") && (
                                    <button
                                        ...
                                        className="font-medium text-base leading-[21px] px-12 py-3 border-[1px] rounded-full transition-all flex items-center gap-2 bg-[#EFBF04] text-[#181D26] border-[#EFBF04] hover:bg-[#181D26] hover:text-[#EFBF04]"
                                    >
                                        {saving ? (
                                            <>
                                                <Loader primary={true} />
