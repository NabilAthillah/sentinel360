                                    ...
                                    <div className="animate-pulse w-full">
                                        ...
                                        <div className="space-y-3">
                                            {Array(6).fill(0).map((_, i) => (
                                                <div key={i} className={`h-3 w-${[56, 64, 44, 56, 48, 100][i]} bg-white/10 rounded`} />
                                            ))}
                        ...
                        >
                            ...
                            {hasPermission("edit_client") && (
                                <button
                                    ...
                                    className="font-medium text-base leading-[21px] px-12 py-3 border-[1px] rounded-full flex items-center gap-2 bg-[#EFBF04] text-[#181D26] border-[#EFBF04] hover:bg-[#181D26] hover:text-[#EFBF04] transition-all"
                                >
