                        ...
                        <div className="w-full flex justify-between items-center gap-4 flex-wrap lg:flex-nowrap">
                            ...
                            {hasPermission('add_sop_document')} {
                                <div className="w-[250px]">
                                    <button type="button" onClick={() => setAddDoc(true)} className="font-medium text-base min-w-[200px] w-full max-w-[250px] text-[#181d26] py-3 border-[1px] border-[#EFBF04] bg-[#EFBF04] rounded-full hover:bg-[#181d26] hover:text-[#EFBF04] transition-all text-center">{t('Add Document')}</button>
                                </div>
                            }
                        </div>
            ...
            <AnimatePresence>
                {viewDoc && (
                    <motion.div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center"
                        ...
                        <div className="flex flex-col gap-6 p-6 bg-[#252C38] rounded-2xl shadow-xl w-[min(92vw,520px)]">
                            ...
                            <button
                                className="w-fit font-medium text-base leading-[21px] text-[#868686] bg-[#252C38] px-12 py-3 border-[1px] border-[#868686] rounded-full transition-all self-end hover:bg-[#868686] hover:text-[#252C38]"
                                onClick={() => setViewDoc(false)}
                            >
                                {t('Close')}
                            </button>
            ...
            <AnimatePresence>
                {editDoc && (
                    <motion.div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center"
                        ...
                        <motion.form onSubmit={handleEdit} className="flex flex-col gap-6 p-6 bg-[#252C38] rounded-2xl shadow-xl w-[min(92vw,520px)]"
                            ...
                            <div className="flex flex-col w-full py-2 rounded-[4px_4px_0px_0px] gap-2">
                                ...
                                />
                                <img
                                    src={`${baseURL || "http://localhost:8000/api"}storage/${editData?.document}`}
                                    className="cursor-pointer"
                                />
                            </div>
                            <div className="flex gap-4 justify-end">
                                <button type="button" onClick={() => { setEditDoc(false); setEditData(null); setImageFile(null); setImageName('') }} className="font-medium text-base leading-[21px] text-[#868686] bg-[#252C38] px-12 py-3 border-[1px] border-[#868686] rounded-full transition-all hover:bg-[#868686] hover:text-[#252C38]">{t('Cancel')}</button>
            ...
            <AnimatePresence>
                {addDoc && (
                    <motion.div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center"
                        ...
                        <motion.form onSubmit={handleSubmit} className="flex flex-col gap-6 p-6 bg-[#252C38] rounded-2xl shadow-xl w-[min(92vw,520px)]"
                            initial={{ y: 20, scale: 0.98, opacity: 0 }}
                            animate={{ y: 0, scale: 1, opacity: 1 }}
                            exit={{ y: 12, scale: 0.98, opacity: 0 }}
                            transition={{ type: "spring", stiffness: 380, damping: 28 }}
                            ...
                            <div className="flex flex-col w-full py-2 rounded-[4px_4px_0px_0px] gap-2">
                                <label className="text-xs leading-[21px] text-[#98A1B3]">{t('SOP Document Image')} <span className='text-xs'>({t('Maximum Size is 5MB')}!)</span></label>
                                <div className="flex items-center gap-4">
                                    <button
                                        type="button"
                                        onClick={() => imageInputRef.current?.click()}
                            ...
                            <div className="flex gap-4 justify-end">
                                <button type="button" onClick={() => { setAddDoc(false); setImageFile(null); setImageName('') }} className="font-medium text-base leading-[21px] text-[#868686] bg-[#252C38] px-12 py-3 border-[1px] border-[#868686] rounded-full transition-all hover:bg-[#868686] hover:text-[#252C38]">{t('Cancel')}</button>
                                <button type="submit" className="font-medium text-base leading-[21px] text-[#181D26] bg-[#EFBF04] px-12 py-3 border-[1px] border-[#EFBF04] rounded-full transition-all hover:bg-[#181D26] hover:text-[#EFBF04]">{loading ? <Loader primary={true} /> : 'Submit'}</button>
                            </div>
                        </motion.form>
