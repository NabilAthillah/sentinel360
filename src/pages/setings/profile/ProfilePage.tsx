    ...
    return (
        <MainLayout>
            <div className='flex flex-col gap-4 px-6 pb-20 w-full h-full'>
                <h2 className='text-2xl leading-9 text-white font-noto'>{t('Profile')}</h2>
                <div className="flex gap-6 flex-wrap lg:flex-nowrap">
                    <div className="flex flex-col w-full gap-6 lg:max-w-80">
                        <div className="flex flex-col gap-4 bg-[#252C38] lg:max-w-80 w-full h-fit p-4 rounded-lg">
                            ...
                            <div className="flex flex-col gap-1">
                                <label htmlFor="" className="text-xs text-[#98A1B3]">{t('NRIC')}</label>
                                <p className="text-base leading-[20px] text-[#F4F7FF]">{user && user.employee ? user.employee.nric_fin_no : '-'}</p>
                            </div>
                            <div className="flex flex-col gap-1">
                                <label htmlFor="" className="text-xs text-[#98A1B3]">{t('Company')}</label>
                                <p className="text-base leading-[20px] text-[#F4F7FF]">{t('Sentinel Group')}</p>
                            </div>
                            <div className="flex flex-col gap-1">
                                <label htmlFor="" className="text-xs text-[#98A1B3]">{t('Contact')}</label>
                                <p className="text-base leading-[20px] text-[#F4F7FF]">{user && user.mobile ? user.mobile : '-'}</p>
                            </div>
                            <div className="flex flex-col gap-1">
                                <label htmlFor="" className="text-xs text-[#98A1B3]">{t('Email')}</label>
                    ...
                    <form onSubmit={handleSubmit} className="w-full p-6 h-full rounded-lg bg-[#252C38] flex flex-col gap-8">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col max-w-[520px] w-full px-4 pt-2 py-2 rounded-[4px_4px_0px_0px] bg-[#222834] border-b-[1px] border-b-[#98A1B3]">
                                <label htmlFor="" className="text-xs leading-[21px] text-[#98A1B3]">{t('Address')}</label>
                                <input
                                    type={"text"}
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base placeholder:text-[#98A1B3] placeholder:text-base active:outline-none focus-visible:outline-none"
                                    placeholder='Address'
                            ...
                            <div className="flex flex-col max-w-[520px] w-full px-4 pt-2 py-2 rounded-[4px_4px_0px_0px] bg-[#222834] border-b-[1px] border-b-[#98A1B3]">
                                <label htmlFor="" className="text-xs leading-[21px] text-[#98A1B3]">{t('Mobile')}</label>
                                <input
                                    type={"text"}
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base placeholder:text-[#98A1B3] placeholder:text-base active:outline-none focus-visible:outline-none"
                                    placeholder='Mobile'
                            ...
                            <div className="flex flex-col max-w-[520px] w-full px-4 pt-2 py-2 rounded-[4px_4px_0px_0px] bg-[#222834] border-b-[1px] border-b-[#98A1B3]">
                                <label htmlFor="" className="text-xs leading-[21px] text-[#98A1B3]">{t('Email')}</label>
                                <input
                                    type={"text"}
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base placeholder:text-[#98A1B3] placeholder:text-base active:outline-none focus-visible:outline-none"
                                    placeholder='Email'
                            ...
                            <div className="flex flex-col max-w-[520px] w-full px-4 pt-2 py-2 rounded-[4px_4px_0px_0px] bg-[#222834] border-b-[1px] border-b-[#98A1B3]">
                                <label htmlFor="" className="text-xs leading-[21px] text-[#98A1B3]">{t('Old Password')}</label>
                                <input
                                    type={"password"}
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base placeholder:text-[#98A1B3] placeholder:text-base active:outline-none focus-visible:outline-none"
                                    placeholder='****'
                            ...
                            <div className="flex flex-col max-w-[520px] w-full px-4 pt-2 py-2 rounded-[4px_4px_0px_0px] bg-[#222834] border-b-[1px] border-b-[#98A1B3]">
                                <label htmlFor="" className="text-xs leading-[21px] text-[#98A1B3]">{t('New Pasword')}</label>
                                <input
                                    type={"password"}
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base placeholder:text-[#98A1B3] placeholder:text-base active:outline-none focus-visible:outline-none"
                                    placeholder='****'
                        ...
                        <div className="flex flex-col gap-3">
                            <label className="text-xs leading-[21px] text-[#98A1B3]">
                                {t('Profile photo')} <span className='text-xs'>({t('Maximum Size is 5MB')}!)</span> <span className='text-red-500 text-[10px]'>* {t('Do not upload if u dont want change')}</span>
                            </label>
                        ...
                        <div className="flex gap-4 flex-wrap">
                            ...
                            <button className="font-medium text-base leading-[21px] text-[#868686] bg-[#252C38] px-12 py-3 border-[1px] border-[#868686] rounded-full transition-all hover:bg-[#868686] hover:text-[#252C38]">{t('Cancel')}</button>
                        </div>
                    </form>
                </div>
            </div>
